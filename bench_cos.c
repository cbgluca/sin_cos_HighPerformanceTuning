/**
 * @file bench_cos.c
 * @brief High-performance benchmark comparing standard math library cosine with
 *        AVX2 Minimax vectorized and 4x unrolled implementations from cos.c.
 *
 ...
 *    total cosine evaluations, providing stable, statistically reliable measurements.
 *
 * 3. Numerical Verification:
 *    Before timing, each implementation is validated against standard library cosf() to verify
...
int main(void)
{
    ...
    printf("======================================================================\n");
    printf("              AVX2 COSINE HIGH-PERFORMANCE BENCHMARK                  \n");
    printf("======================================================================\n");
    ...
    my_cos_avx_minimax(in, out_minimax, N);
    my_cos_avx_minimax_unrolled(in, out_unrolled, N);
    ...
    printf("--- ACCURACY VERIFICATION (vs standard cosf) ---\n");
    printf("Max Error (Minimax)         : %.6e\n", max_err_minimax);
    printf("Max Error (Minimax Unrolled): %.6e\n", max_err_unrolled);
    printf("----------------------------------------------------------------------\n\n");

    // =========================================================================
    // BENCHMARK 1: Standard math.h (cosf - scalar / auto-vectorized baseline)
    // =========================================================================
    ...
    // =========================================================================
    // BENCHMARK 2: AVX2 Minimax (my_cos_avx_minimax)
    // =========================================================================
    ...
    // =========================================================================
    // BENCHMARK 3: AVX2 Minimax 4x Unrolled (my_cos_avx_minimax_unrolled)
    // =========================================================================
    ...
    printf("[2] AVX2 Minimax (my_cos_avx_minimax):\n");
    printf("    Total Execution Time : %8.4f seconds\n", time_minimax);
    printf("    Throughput           : %8.2e operations/sec\n", thr_minimax);
    printf("    Average Latency      : %8.2f ns/op\n", lat_minimax);
    printf("    Speedup              : %8.2fx vs baseline\n\n", time_std / time_minimax);

    printf("[3] AVX2 Minimax Unrolled (my_cos_avx_minimax_unrolled):\n");
    printf("    Total Execution Time : %8.4f seconds\n", time_unrolled);
    printf("    Throughput           : %8.2e operations/sec\n", thr_unrolled);
    printf("    Average Latency      : %8.2f ns/op\n", lat_unrolled);
